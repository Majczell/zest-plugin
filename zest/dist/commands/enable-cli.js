...
async function main() {
  try {
    ...
    logger.error("Failed to enable remote persistence", error);
    console.error("❌ Failed to enable: " + (error instanceof Error ? error.message : "Unknown error"));
    process.exit(1);
  }
}
main();

//# debugId=15B3DD4CED534B3F64756E2164756E21
